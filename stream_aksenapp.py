...
"""
pip install pygments markdown-it-py rich mdurl
...
st.title("🎙️ Few-Shot Accent Detection with Multi-Task Learning")
st.markdown("""
...
def main():
    ...
    with tab3:
        ...
        **Architecture Overview:**
        ...
        ```
        Input Audio → MFCC Features → Embedding Network → Prototypes → Predictions
                               ↓
